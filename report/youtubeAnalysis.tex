...
% ==============================================================================
Nakon pretprocesiranja i čišćenja podataka, pre same klasifikacije izbacujemo atribut video\_id, normalizujemo podatke i delimo ih na skup za obučavanje i skup za testiranje.
...
Koristeći tako modifikovane podatke, četiri algoritma će pokušati da predvide da li će video ponovo biti na trendingu. Svi meta parametri su podešeni kako bi se dobili što bolji rezultati, a konačni rezultati za svaki metod su:
\\ 
\begin{figure}[h!]
\begin{center}
...
\\ \\
Takođe, treba primetiti da se algoritam stablo odlučivanja i RTF izvršavaju za manje od jednog minuta, MLP sa 3 skrivena sloja i 500 iteracija za 3 minuta, dok je SVM algoritmu, čiji je ulaz transformisan PCA procedurom na 4 dimenzije sa očuvanih 95\% podataka, potrebno više od 20 minuta na istom računaru i ima najlošije rezultate. Ovakav rezultat je posledica kompleksnosti SVM algoritma i nemogućnosti za finim podešavanjem parametara zbog dužine izvršavanja.
% ==============================================================================
\section{Pravila pridruživanja}
\label{sec:pravila}
% ==============================================================================

Transformacijom niski tagova i naslova u nizove i primenom algoritma za generisanje pravila pridruživanja dobili smo sledeće rezultate:
...
U sledećim podsekcijama će se koristiti termin koji nije ranije definisan:
angažovanost = (broj lajkova + broj dislajkova + broj komentara) / broj pregleda
...
U sekciji Pretrprocesiranje je opisan proces dodavanja kategorija u skup video klipova.  
...
Na prethodne dve slike se može primetiti da većinu ne predstavlja ista kategorija. Takva informacija je i očekivana, zato što se pesme ne objavljuju često koliko zabavni klipovi, ali se preslušavaju daleko češće.
